...
public class Task3 {
	...
	public static void main(String[] args) {
		...
		//too  small.  The  program  will  keep asking  the  user  to  enter  the  number  until he  finds 
		//the  correct  number.  When  the correct answer is found the system should display "Congratulations!!.
		//You got it!"
		Scanner scan;
